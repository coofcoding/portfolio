const _twitterHover = document.getElementById("_twitterHover");
const _gmailHover = document.getElementById("_gmailHover");
...
_twitterHover.addEventListener("mouseleave", () => {
...
_gmailHover.addEventListener("mouseover", () => {
...
_gmailHover.addEventListener("mouseleave", () => {
...
_linkedinHover.addEventListener("mouseover", () => {
...
_linkedinHover.addEventListener("mouseleave", () => {
...
_githubHover.addEventListener("mouseover", () => {
...
_githubHover.addEventListener("mouseleave", () => {
...
_igHover.addEventListener("mouseover", () => {
